...
fprintf(fID,'\\begin{tabular}{r|c|c|c|c|c|c}');
formatequ=['\r\n\\multicolumn{7}{c}{\\(f(x)=',num2str(tableinfo.coefficient),'x^',num2str(tableinfo.degree),'\\)}\\\\'];
fprintf(fID,formatequ);
fprintf(fID,'\r\n\\midrule');
fprintf(fID,'\r\nMethod & Failed & Real & RelError & InfinityRatio & TwoRatio & Time \\\\ \r\n\\toprule') ;
...
data=[naginfo.secondattempt,naginfo.realintegral,naginfo.error,...
    naginfo.inormratio,naginfo.ratio2norm,time]';
% xlswrite(filename,data,'Sheet1','B2')
formatspec=['\r\n\\midrule \r\n',tableinfo.quadtype,' & %8.4f & %8.4f & %8.4f & %8.4f & %8.4f & %8.4f \\\\'];
...
data=[info.secondattempt,info.realintegral,info.error,...
    info.inormratio,info.ratio2norm,time]';
% xlswrite(filename,data,'Sheet1','E2')
formatspec=['\r\n\\midrule \r\n',tableinfo.fname,' & %8.4f & %8.4f & %8.4f & %8.4f & %8.4f & %8.4f \\\\'];
fprintf(fID,formatspec,data);
