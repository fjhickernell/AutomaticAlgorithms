...
\]
The theoretical properties of embedded rank-1 lattices are discussed in \cite{HicNie03a}.  To do this, one chooses $\bsz_1, \bsz_b, \bsz_{b^2},  \ldots \in \cube$ such that 
