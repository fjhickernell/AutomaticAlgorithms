...
\smartqed
%\usepackage{mathabx}        % own package to use widecheck
...
\newcommand{\naturals}{\mathbb{N}} % natural numbers {1, 2, ...}
\newcommand{\Q}{\mathbb{Q}} % rationals
\newcommand{\F}{\mathbb{F}} % field, finite field
\newcommand{\floor}[1]{\left\lfloor #1 \right\rfloor} % floor
\newcommand{\ceil}[1]{\left\lceil #1 \right\rceil}    % ceil
\newcommand{\dif}{\,\mathrm{d}} % differential symbol for use in integrals
% vectors as boldsymbols:
\newcommand{\vzero}{\boldsymbol{0}} % vector of zeros
\newcommand{\bsone}{\boldsymbol{1}}  % vector of ones
\newcommand{\vt}{\boldsymbol{t}}    % vector t
\newcommand{\bsu}{\boldsymbol{u}}    % vector u
\newcommand{\bsv}{\boldsymbol{v}}    % vector v
\newcommand{\bsw}{\boldsymbol{w}}    % vector w
\newcommand{\vx}{\boldsymbol{x}}    % vector x
\newcommand{\vy}{\boldsymbol{y}}    % vector y
\newcommand{\vz}{\boldsymbol{z}}    % vector z
\newcommand{\vDelta}{\boldsymbol{\Delta}}    % vector \Delta
% sets as Euler fraks:
\newcommand{\setu}{\mathfrak{u}}
\newcommand{\setv}{\mathfrak{v}}
% indicator boldface 1:
\newcommand{\ind}{\mathbbold{1}}
\usepackage{bbm} % alternative to \ind since it is not working
...
\newcommand{\va}{\boldsymbol{a}}    % vector a
\newcommand{\vk}{\boldsymbol{k}}    % vector k
\newcommand{\tvk}{\tilde{\vk}}
\newcommand{\vl}{\boldsymbol{l}}    % vector l
\newcommand{\vj}{\boldsymbol{j}}    % vector j
...
\usepackage{mathtools} % for commands \MoveEqLeft and \widecheck
...
\institute{
Fred J.\ Hickernell
\at Illinois Institute of Technology, Room E1-208, 10 W.\ 32$^{\text{nd}}$ St., Chicago, USA
\email{hickernell@iit.edu}
%
\and
%
Llu\'is Antoni Jim\'enez Rugama
\at Illinois Institute of Technology, Room E1-120, 10 W.\ 32$^{\text{nd}}$ St., Chicago, USA
\email{lluisantoni@gmail.com}
}
\maketitle
