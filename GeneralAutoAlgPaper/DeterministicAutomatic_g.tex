...
\end{equation}
for some known non-negative valued, non-increasing functions $h_{\pm}$ satisfying $\sup_{n \in \ci} h_{\pm}(n) = 0$.  Then the set of input functions for which the adaptive algorithms are defined is the cone
